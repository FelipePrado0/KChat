...
const privateMessageRoutes = require('./backend/routes/privateMessageRoutes');
const groupRoutes = require('./backend/routes/groupRoutes');
const { initializeDatabase, logApi } = require('./backend/utils/dbInit');
const { extractEmpresa } = require('./backend/utils/helpers');
